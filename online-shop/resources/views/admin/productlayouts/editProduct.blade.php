    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <form method="POST" action="{{ url('admin/' . $products->id) }}" enctype="multipart/form-data">
                ...
                <input class="form-control" step="0.01" type="number" name="discount"
                ...
                <div class="form-group form-check form-group col-6">
                    ...
                    <input type="checkbox" name='is_featured' checked="{{ old($products->is_featured) }}">
                    <label>Recent</label>
                    <input type="checkbox" name='is_recent' checked="{{ old($products->is_recent) }}">
                </div>

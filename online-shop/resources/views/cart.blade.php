                        ...
                        <tbody class="align-middle" id="products">
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td class="align-middle">${{ $product->getPriceWithDiscount() }}</td>
                                    <td class="align-middle">
                                        <div class="input-group quantity mx-auto" style="width: 100px">
                                            <div class="input-group-btn">
                                                <button type="button" class="decBtn btn btn-sm btn-primary btn-minus"
                                                    onclick="decProduct({{ $product['id'] }})">
                                    ...
                                    <td class="align-middle">$
                                        {{ $product->getPriceWithDiscount() * $quantity[$product['id']] }}</td>
                                    <td class="align-middle">
